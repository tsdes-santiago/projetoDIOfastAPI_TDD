...
async def test_usecases_get_should_return_not_found():
    with pytest.raises(NotFoundException) as err:
        await product_usecase.get(id=UUID("ba7e06d8-7923-4401-bd39-dadbb443de18"))

    assert (
        err.value.message
        == "Product not found with filter: ba7e06d8-7923-4401-bd39-dadbb443de18"
    )
...
async def test_usecases_delete_should_return_not_found():
    with pytest.raises(NotFoundException) as err:
        await product_usecase.delete(id=UUID("ba7e06d8-7923-4401-bd39-dadbb443de18"))
